...
app.config(function($routeProvider){
	$routeProvider
		.when("/home",{
			templateUrl:"tpls/route/home.html",
			controller:"homeCtrl"
		})
		.when("/login",{
			templateUrl:"tpls/route/login.html",
			controller:"loginCtrl"
		})
		.when("/register",{
			templateUrl:"tpls/route/register.html",
			controller:"registerCtrl"
		})
		.when("/detail/:id",{
			templateUrl:"tpls/route/detail.html",
			controller:"detailCtrl"
		})
		.when("/cart",{
			templateUrl:"tpls/route/cart.html",
			controller:"cartCtrl"
		})
});
...
//		$http.get("http://datainfo.duapp.com/shopdata/userinfo.php?status=login&userID"+$scope.userID+"&password="+$scope.password)
//		.then(function(data){
//			console.log(data)
////			$location.path("/home")
...
//		})
	$http.jsonp("http://datainfo.duapp.com/shopdata/getGoods.php?callback=JSON_CALLBACK&goodsID="+$routeParams.id)
		.success(function(data){
			console.log(data)
			$scope.pro = data[0].goodsName;
		})
})
...
//		$http.get("http://datainfo.duapp.com/shopdata/userinfo.php?status=register&userID"+$scope.userID+"&password="+$scope.password)
//		.then(function(data){
//			console.log(data)
//		})
	}
